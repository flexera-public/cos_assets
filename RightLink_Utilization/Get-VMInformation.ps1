...
$accounts = Read-Host "Enter comma separated list of RS Account Number(s) or the Parent Account number. Example: 1234,4321,1111" # RS account numbers
        ...
        foreach ($cloud in $clouds) {
            ...
            if(!($instances)) {
                ...
                foreach ($instance in $instances) {
                    ...
                    $object | Add-Member -MemberType NoteProperty -Name "OS_Platform" -Value $instance.os_platform ## Requires extended view
